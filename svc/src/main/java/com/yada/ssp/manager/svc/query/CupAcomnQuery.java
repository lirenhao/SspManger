...
public class CupAcomnQuery implements Specification<CupAcomn> {
    ...
    @Override
    public Predicate toPredicate(Root<CupAcomn> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        ...
        if(null != orgId && !"".equals(orgId)) {
            Join<CupAcomn, Merchant> joinMerchant = root.join("merchant");
